...
- Which skills from `.claude/skills/` apply? (experience-principles, supabase-rls-pattern, i18n-source-of-truth, design-system-enforcement, asaas-integration)
...
- asaas-integration (if payment)
- i18n-source-of-truth (if new copy)
