...
|-------|---------------------|---------------------|
| `code-reviewer` | Code quality / security findings | Scope clarity |
| `a11y-architect` | Accessibility findings | UX requirements |
| `silent-failure-hunter` | Robustness findings | Failure mode definitions |
