...
skills: experience-principles, i18n-source-of-truth, design-system-enforcement
memory: project
model: sonnet
---
...
- Payment webhook handler without HMAC / IP allow-list.
...
### i18n / copy (HIGH for user-facing)

- Hard-coded literal string in JSX. All user-facing copy must go through the i18n layer.
- Mixed languages in same component.
- Adding key to one locale but not all (paridade quebrada). See `i18n-source-of-truth` skill.
