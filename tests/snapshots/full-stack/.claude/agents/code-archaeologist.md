...
|---|---|---|
| `silent-failure-hunter` | Catches that hide errors | Where the legacy fallback comes from |
| `security-reviewer` | Vulnerability checks | Legacy auth patterns |
| `refactor-cleaner` | Dead code audit | Cleanup plan |
...
- Migrating across major versions / paradigms.
